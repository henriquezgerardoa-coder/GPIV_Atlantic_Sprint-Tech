    ...
    public SecurityFilterChain filtroSeguridad(HttpSecurity http, FiltroLimitacionIngreso filtroLimitacionIngreso) throws Exception {
        http
            ...
            .authorizeHttpRequests(autorizacion -> autorizacion
                ...
                .requestMatchers(HttpMethod.GET, "/api/empresas/**").hasAnyRole("ADMINISTRADOR", "OPERADOR", "EMPRESA")
                .requestMatchers(HttpMethod.GET, "/api/lotes/**").hasAnyRole("ADMINISTRADOR", "OPERADOR", "EMPRESA")
                ...
                // R-14: informes/estadisticas solo para ADMINISTRADOR y OPERADOR (lectura legislativa).
                // El rol EMPRESA no accede a estadisticas globales.
                .requestMatchers("/api/estadisticas/**").hasAnyRole("ADMINISTRADOR", "OPERADOR")
                .requestMatchers(HttpMethod.GET, "/api/radicaciones/**").hasAnyRole("ADMINISTRADOR", "OPERADOR", "EMPRESA")
                ...
                .requestMatchers(HttpMethod.PATCH, "/api/radicaciones/*/estado").hasAnyRole("ADMINISTRADOR", "OPERADOR")
                .requestMatchers(HttpMethod.POST, "/api/radicaciones/*/observaciones").hasAnyRole("ADMINISTRADOR", "OPERADOR")
