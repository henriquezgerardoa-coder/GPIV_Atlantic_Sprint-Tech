    ...
    public SecurityFilterChain filtroSeguridad(HttpSecurity http, FiltroLimitacionIngreso filtroLimitacionIngreso) throws Exception {
        http
            ...
            .authorizeHttpRequests(autorizacion -> autorizacion
                ...
                .requestMatchers(HttpMethod.PATCH, "/api/usuarios/*/activar").hasAnyRole("ADMINISTRADOR", "SECRETARIO")
                .requestMatchers(HttpMethod.PATCH, "/api/usuarios/*/desactivar").hasAnyRole("ADMINISTRADOR", "SECRETARIO")
                ...
                .requestMatchers(HttpMethod.PATCH, "/api/empresas/*/inactivar").hasAnyRole("ADMINISTRADOR", "SECRETARIO")
                .requestMatchers(HttpMethod.PATCH, "/api/empresas/*/reactivar").hasAnyRole("ADMINISTRADOR", "SECRETARIO")
                ...
                .requestMatchers(HttpMethod.PATCH, "/api/proyectos/*/estado").hasAnyRole("ADMINISTRADOR", "SECRETARIO", "TECNICO")
                .requestMatchers("/api/proyectos/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "SECRETARIO", "TECNICO")
                .requestMatchers(HttpMethod.DELETE, "/api/infraestructura/*").hasRole("ADMINISTRADOR")
                .requestMatchers(HttpMethod.GET, "/api/infraestructura").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "SECRETARIO", "EMPRESA")
                .requestMatchers("/api/infraestructura/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "SECRETARIO")
