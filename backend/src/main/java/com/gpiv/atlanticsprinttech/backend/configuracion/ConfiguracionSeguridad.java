    ...
    public SecurityFilterChain filtroSeguridad(HttpSecurity http, FiltroLimitacionIngreso filtroLimitacionIngreso) throws Exception {
        http
            ...
            .authorizeHttpRequests(autorizacion -> autorizacion
                ...
                .requestMatchers(HttpMethod.GET, "/api/proyectos", "/api/proyectos/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "SECRETARIO")
                .requestMatchers(HttpMethod.POST, "/api/proyectos").hasAnyRole("ADMINISTRADOR", "SECRETARIO")
                .requestMatchers(HttpMethod.POST, "/api/proyectos/*/hitos").hasAnyRole("ADMINISTRADOR", "SECRETARIO")
                .requestMatchers(HttpMethod.PATCH, "/api/proyectos/*/hitos/*/cumplido").hasAnyRole("ADMINISTRADOR", "SECRETARIO")
                .requestMatchers(HttpMethod.PATCH, "/api/proyectos/*/estado").hasAnyRole("ADMINISTRADOR", "SECRETARIO")
                .requestMatchers(HttpMethod.DELETE, "/api/proyectos/*/hitos/*").hasAnyRole("ADMINISTRADOR", "SECRETARIO")
                .requestMatchers("/api/proyectos/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "SECRETARIO")
                ...
                .requestMatchers("/api/mensajeria/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "EMPRESA", "SECRETARIO")
