    ...
    public SecurityFilterChain filtroSeguridad(HttpSecurity http, FiltroLimitacionIngreso filtroLimitacionIngreso) throws Exception {
        http
            ...
            .authorizeHttpRequests(autorizacion -> autorizacion
                ...
                .requestMatchers(HttpMethod.POST, "/api/lotes/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO")
                .requestMatchers(HttpMethod.PUT, "/api/lotes/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO")
                .requestMatchers(HttpMethod.DELETE, "/api/lotes/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO")
                ...
                .requestMatchers(HttpMethod.GET, "/api/proyectos", "/api/proyectos/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "TECNICO")
                .requestMatchers(HttpMethod.POST, "/api/proyectos/*/hitos").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "TECNICO")
                .requestMatchers(HttpMethod.PATCH, "/api/proyectos/*/hitos/*/cumplido").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "TECNICO")
                .requestMatchers(HttpMethod.DELETE, "/api/proyectos/*/hitos/*").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "TECNICO")
                ...
                .requestMatchers("/api/mensajeria/**").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "EMPRESA")
                ...
                .requestMatchers(HttpMethod.POST, "/api/radicaciones/*/documentos").hasAnyRole("EMPRESA", "ADMINISTRADOR", "SECRETARIO")
                .requestMatchers(HttpMethod.PATCH, "/api/radicaciones/*/estado").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "SECRETARIO")
                .requestMatchers(HttpMethod.POST, "/api/radicaciones/*/observaciones").hasAnyRole("ADMINISTRADOR", "DIRECTIVO", "SECRETARIO")
