...
function inicializarContextoIngreso() {
    ...
    if (verificacion === 'ok') {
        ...
        mostrarMensajeContexto('Registro completado. Ya puedes iniciar sesion con tu usuario y contrasena.', 'info');
    }
...
document.getElementById('formularioIngreso').addEventListener('submit', async (evento) => {
    ...
    const credencial = Credenciales.codificarBasicAuth(nombreUsuario, clave);
